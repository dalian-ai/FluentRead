...
import { MAX_TOKENS_PER_BATCH } from '../utils/batchTranslate';
...
export function autoTranslateEnglishPage() {
    ...
    if (totalTokens > MAX_TOKENS_PER_BATCH) {
        console.log(`[FluentRead] 全文超过${MAX_TOKENS_PER_BATCH} tokens限制，将只翻译前${MAX_TOKENS_PER_BATCH} tokens`);
        nodes = truncateNodesByTokens(allNodes, MAX_TOKENS_PER_BATCH);
    } else {
